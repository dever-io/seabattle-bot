# E2T1 — Profile Creation Onboarding

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

When a user first interacts with the bot (via /start or invite link), create a profile using their Telegram ID and display name. Show a 'Get Started' button if needed. Implement in src/handlers/onboarding.ts and write tests/specs/onboarding.json.
