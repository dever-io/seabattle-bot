# E1T1 — Quick Match Button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

Implement the 'Quick Match' inline button (callback_data: matchmaking:quick) in src/handlers/quick-match.ts. When tapped, initiate matchmaking logic and show a loading indicator. Write tests/specs/quick-match.json to validate the button triggers matchmaking.
