# E7T2 — Turn Notifications

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

Implement push notifications in src/handlers/notifications.ts when an opponent makes a move. Include an inline 'Your Turn' button linking to the match. Write tests/specs/notifications.json for message delivery validation.
