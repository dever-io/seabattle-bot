# E1T2 — Play with Friend Button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

Implement the 'Play with Friend' inline button (callback_data: invite:create) in src/handlers/friend-invite.ts. Generate a deep-link invite code (t.me/YourBot?start=invite_<code>) with 7-day expiration. Write tests/specs/friend-invite.json for invite creation and sharing.
