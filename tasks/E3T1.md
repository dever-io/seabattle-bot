# E3T1 — Leaderboard Display

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

Create the 'Leaderboard' inline button (callback_data: leaderboard:view) in src/handlers/leaderboard.ts. Fetch and display top users with pagination controls. Write tests/specs/leaderboard.json for validation.
