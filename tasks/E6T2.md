# E6T2 — Auto-Placement Logic

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

Implement 'Auto-place all' and 'Randomize' functionality in src/handlers/ship-placement.ts. Generate valid ship placements according to standard Battleship rules. Write tests/specs/ship-placement-auto.json for algorithm validation.
