# E4T2 — Rating Window Expansion

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

Implement logic in src/handlers/matchmaking.ts to expand the rating window by 100 every 15s if no opponent is found. Handle fallback options (wait or switch to friend invite). Write tests/specs/matchmaking-expansion.json for timeout behavior.
