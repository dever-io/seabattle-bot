# E4T1 — Quick Match Logic

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

Implement matchmaking logic in src/handlers/matchmaking.ts. When a user taps Quick Match, search for an opponent and send both players a 'Place ships now' or 'Auto-place' confirmation. Write tests/specs/matchmaking.json for match creation validation.
